...
public class ItemIDs {
	...
	// Materials
	public static int DEFAULT_DUST = 3900;
	public static int DEFAULT_DUST_SALTPETER = 3901;
	public static int DEFAULT_DUST_SULFUR = 3902;
	public static int DEFAULT_DUST_REDSILVER = 3903;
	public static int DEFAULT_DUST_GRAPHITE = 3904;
	public static int DEFAULT_PLASTIC_GLOB = 3905;

	public static int DEFAULT_INGOT = 3910;
	public static int DEFAULT_INGOT_REDSILVER = 3911;
	public static int DEFAULT_PLASTIC = 3912;

	// Other
	public static int DEFAULT_MISC = 3950;
	public static int DEFAULT_BUCKET_EMPTY = 3951;
	public static int DEFAULT_BUCKET_WATER = 3952;
	public static int DEFAULT_BUCKET_MILK = 3953;

	// Tools
	public static int DEFAULT_STONE_HAMMER = 4000;
	public static int DEFAULT_IRON_HAMMER = 4001;
	public static int DEFAULT_STEEL_HAMMER = 4002;
	public static int DEFAULT_CARBIDE_HAMMER = 4003;

	public static int DEFAULT_COPPER_AXE = 4010;
	public static int DEFAULT_BRONZE_AXE = 4011;
	public static int DEFAULT_STEEL_AXE = 4012;
	public static int DEFAULT_TITANIUM_AXE = 4013;
	...
	public static int DEFAULT_STEEL_HOE = 4022;
	public static int DEFAULT_TITANIUM_HOE = 4023;
	...
	public static int DEFAULT_STEEL_SPADE = 4032;
	public static int DEFAULT_TITANIUM_SPADE = 4033;
	...
	public static int DEFAULT_STEEL_PICKAXE = 4042;
	public static int DEFAULT_TITANIUM_PICKAXE = 4043;
	...
	public static int DEFAULT_STEEL_SWORD = 4052;
	public static int DEFAULT_TITANIUM_SWORD = 4053;
	...
	public static int DEFAULT_BRONZE_HEAD = 4101;
	public static int DEFAULT_STEEL_HEAD = 4102;
	...
	public static int DEFAULT_BRONZE_CHEST = 4111;
	public static int DEFAULT_STEEL_CHEST = 4112;
	...
	public static int DEFAULT_BRONZE_LEGS = 4121;
	public static int DEFAULT_STEEL_LEGS = 4122;
	...
	public static int DEFAULT_BRONZE_FEET = 4131;
	public static int DEFAULT_STEEL_FEET = 4132;
	...
	// Molds
	public static int DEFAULT_MOLD = 4200;

	public static int DEFAULT_MOLDF_AXE = 4201;
	public static int DEFAULT_MOLDF_HOE = 4202;
	public static int DEFAULT_MOLDF_SPADE = 4203;
	public static int DEFAULT_MOLDF_PICK = 4204;
	public static int DEFAULT_MOLDF_SWORD = 4205;
	public static int DEFAULT_MOLDF_HEAD = 4206;
	public static int DEFAULT_MOLDF_CHEST = 4207;
	public static int DEFAULT_MOLDF_LEGS = 4208;
	public static int DEFAULT_MOLDF_FEET = 4209;

	// Tool Heads
	public static int DEFAULT_HEAD_AXE = 4210;
	public static int DEFAULT_HEAD_HOE = 4211;
	public static int DEFAULT_HEAD_SPADE = 4212;
	public static int DEFAULT_HEAD_PICK = 4213;
	public static int DEFAULT_HEAD_SWORD = 4214;

	//
	// Materials
	public static int DUST;
	public static int DUST_SALTPETER;
	public static int DUST_SULFUR;
	public static int DUST_REDSILVER;
	public static int DUST_GRAPHITE;
	public static int PLASTIC_GLOB;

	public static int INGOT;
	public static int INGOT_REDSILVER;
	public static int PLASTIC;

	// Other
	public static int MISC;
	public static int BUCKET_EMPTY;
	public static int BUCKET_WATER;
	public static int BUCKET_MILK;

	// Tools
	public static int STONE_HAMMER;
	public static int IRON_HAMMER;
	public static int STEEL_HAMMER;
	public static int CARBIDE_HAMMER;

	public static int COPPER_AXE;
	public static int BRONZE_AXE;
	public static int STEEL_AXE;
	...
	public static int STEEL_SPADE;
	public static int TITANIUM_SPADE;
	...
	public static int BRONZE_HEAD;
	public static int STEEL_HEAD;
	...
	public static int BRONZE_CHEST;
	public static int STEEL_CHEST;
	...
	public static int BRONZE_LEGS;
	public static int STEEL_LEGS;
	...
	public static int BRONZE_FEET;
	public static int STEEL_FEET;
	...
	public static int MOLDF_AXE;
	public static int MOLDF_HOE;
	public static int MOLDF_SPADE;
	public static int MOLDF_PICK;
	public static int MOLDF_SWORD;
	public static int MOLDF_HEAD;
	public static int MOLDF_CHEST;
	public static int MOLDF_LEGS;
	public static int MOLDF_FEET;

	// Tool Heads
	public static int HEAD_AXE;
