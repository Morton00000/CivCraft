...
public class TileFurnaceInd extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory {
	...
	public void updateEntity() {
		...
		if (!worldObj.isRemote) {
			...
			if (flag != furnaceBurnTime > 0) {
				flag1 = true;
				FurnaceInd.updateFurnaceBlockState(furnaceBurnTime > 0, worldObj, xCoord, yCoord, zCoord);
			}
		}
	...
	private boolean canSmelt() {
		if (furnaceItemStacks[0] == null)
			...
			ItemStack itemstack = RecipesFurnaceInd.smelting().getSmeltingResult(furnaceItemStacks[0]);
			if (itemstack == null)
				return false;
