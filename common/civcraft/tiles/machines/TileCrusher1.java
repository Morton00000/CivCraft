...
public class TileCrusher1 extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory {
	...
	public void updateEntity() {
		...
		if (!worldObj.isRemote) {
			...
			if (flag != furnaceBurnTime > 0) {
				flag1 = true;
				Crusher1.updateFurnaceBlockState(furnaceBurnTime > 0, worldObj, xCoord, yCoord, zCoord);
			}
		}
	...
	private boolean canSmelt() {
		if (furnaceItemStacks[0] == null)
			...
			ItemStack itemstack = RecipesCrusher1.smelting().getSmeltingResult(furnaceItemStacks[0]);
			if (itemstack == null)
				return false;
