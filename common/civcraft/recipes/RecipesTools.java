...
public class RecipesTools {
	...
	public static void init() {
		...
		// Axe
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(Tools.axeAluminium, 1), new Object[] { "xx", "xy", " y", 'x', "ingotAluminium", 'y', "stickWood" }));
		...
		// Hoe
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(Tools.hoeAluminium, 1), new Object[] { "xx", " y", " y", 'x', "ingotAluminium", 'y', "stickWood" }));
		...
		// Shovels
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(Tools.spadeAluminium, 1), new Object[] { "x", "y", "y", 'x', "ingotAluminium", 'y', "stickWood" }));
		...
		// Pickaxe
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(Tools.pickaxeAluminium, 1), new Object[] { "xxx", " y ", " y ", 'x', "ingotAluminium", 'y', "stickWood" }));
		...
		// Swords
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(Tools.swordAluminium, 1), new Object[] { "x", "x", "y", 'x', "ingotAluminium", 'y', "stickWood" }));
