...
public class RecipesPlasticOven {
	private static final RecipesPlasticOven smeltingBase = new RecipesPlasticOven();
	 ...
	 */
	public static final RecipesPlasticOven smelting() {
		return smeltingBase;
	}

	private RecipesPlasticOven() {
