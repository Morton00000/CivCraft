...
public class RecipesCrusher2 {
	private static final RecipesCrusher2 smeltingBase = new RecipesCrusher2();
	 ...
	 */
	public static final RecipesCrusher2 smelting() {
		return smeltingBase;
	}

	private RecipesCrusher2() {
		...
		this.addSmelting(Blocks.oreTungsten.itemID, 9, new ItemStack(Materials.dust, 2, 9), 0.0F);
		this.addSmelting(Blocks.oreUranium.itemID, 10, new ItemStack(Materials.dust, 2, 10), 0.0F);
