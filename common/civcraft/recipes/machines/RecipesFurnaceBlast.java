...
public class RecipesFurnaceBlast {
	private static final RecipesFurnaceBlast smeltingBase = new RecipesFurnaceBlast();
	 ...
	 */
	public static final RecipesFurnaceBlast smelting() {
		return smeltingBase;
	}

	private RecipesFurnaceBlast() {
