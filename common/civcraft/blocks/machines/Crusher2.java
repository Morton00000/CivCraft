...
public class Crusher2 extends BlockContainer {
	...
	public Crusher2(int par1, boolean par2) {
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Machines.crusher2Off.blockID;
	}
	...
	public void registerIcons(IconRegister par1IconRegister) {
		blockIcon = par1IconRegister.registerIcon("/mods/CivCraft/textures/blocks/machines/crusher2_side.png");
		field_94459_cP = par1IconRegister.registerIcon(isActive ? "/mods/CivCraft/textures/blocks/machines/crusher2_front_lit.png" : "/mods/CivCraft/textures/blocks/machines/crusher2_front.png");
		field_94458_cO = par1IconRegister.registerIcon("/mods/CivCraft/textures/blocks/machines/crusher2_top.png");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		...
		if (player.isSneaking())
			...
			if (!world.isRemote) {
				...
				if (tileCrusher2 != null) {
					player.openGui(CivCraftBase.instance, GuiIDs.CRUSHER_2, world, x, y, z);
				}
			}
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, Machines.crusher2On.blockID);
		} else {
			par1World.setBlock(par2, par3, par4, Machines.crusher2Off.blockID);
		}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack) {
		...
		if (par6ItemStack.hasDisplayName()) {
			((TileCrusher2) par1World.getBlockTileEntity(par2, par3, par4)).func_94129_a(par6ItemStack.getDisplayName());
		}
	}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6) {
		if (!keepFurnaceInventory) {
			TileCrusher2 tileentityfurnace = (TileCrusher2) par1World.getBlockTileEntity(par2, par3, par4);
