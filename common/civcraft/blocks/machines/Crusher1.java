...
public class Crusher1 extends BlockContainer {
	...
	public Crusher1(int par1, boolean par2) {
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Machines.crusher1Off.blockID;
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		...
		if (player.isSneaking())
			...
			if (!world.isRemote) {
				...
				if (tileCrusher1 != null) {
					player.openGui(CivCraftBase.instance, GuiIDs.CRUSHER_1, world, x, y, z);
				}
			}
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, Machines.crusher1On.blockID);
		} else {
			par1World.setBlock(par2, par3, par4, Machines.crusher1Off.blockID);
		}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack) {
		...
		if (par6ItemStack.hasDisplayName()) {
			((TileCrusher1) par1World.getBlockTileEntity(par2, par3, par4)).func_94129_a(par6ItemStack.getDisplayName());
		}
	}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6) {
		if (!keepFurnaceInventory) {
			TileCrusher1 tileentityfurnace = (TileCrusher1) par1World.getBlockTileEntity(par2, par3, par4);
