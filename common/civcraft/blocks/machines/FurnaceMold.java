...
public class FurnaceMold extends BlockContainer {
	...
	public FurnaceMold(int par1, boolean par2) {
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return Machines.furnaceMoldOff.blockID;
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		...
		if (player.isSneaking())
			...
			if (!world.isRemote) {
				...
				if (tileFurnaceMold != null) {
					player.openGui(CivCraftBase.instance, GuiIDs.FURNACE_MOLD, world, x, y, z);
				}
			}
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4, Machines.furnaceMoldOn.blockID);
		} else {
			par1World.setBlock(par2, par3, par4, Machines.furnaceMoldOff.blockID);
		}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack) {
		...
		if (par6ItemStack.hasDisplayName()) {
			((TileFurnaceMold) par1World.getBlockTileEntity(par2, par3, par4)).func_94129_a(par6ItemStack.getDisplayName());
		}
	}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6) {
		if (!keepFurnaceInventory) {
			TileFurnaceMold tileentityfurnace = (TileFurnaceMold) par1World.getBlockTileEntity(par2, par3, par4);
