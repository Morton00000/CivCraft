...
import civcraft.recipes.machines.RecipesCrusher1;
import civcraft.slots.machines.SlotCrusher1;
import civcraft.tiles.machines.TileCrusher1;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class ContainerCrusher1 extends Container {
	private TileCrusher1 furnace;
	private int lastCookTime = 0;
	private int lastBurnTime = 0;
	private int lastItemBurnTime = 0;

	public ContainerCrusher1(InventoryPlayer par1InventoryPlayer, TileCrusher1 par2TileEntityFurnace) {
		...
		this.addSlotToContainer(new SlotCrusher1(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
		int i;
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (par2 == 2) {
				...
				if (RecipesCrusher1.smelting().getSmeltingResult(itemstack1) != null) {
					if (!this.mergeItemStack(itemstack1, 0, 1, false))
						return null;
				} else if (TileCrusher1.isItemFuel(itemstack1)) {
