...
public class HeadsSword extends Item {
	...
	public static final String[] swordHeadNames = new String[] { "copper", "Aluminium", "titanium", "duranium", "bronze", "steel", "carbide", "dcarbide", "iron", "gold" };

	public static final String[] swordHead = new String[] { "copper", "Aluminium", "titanium", "duranium", "bronze", "steel", "carbide", "dcarbide", "iron", "gold" };
	...
	public void updateIcons(IconRegister iconRegistry) {
		...
		textures[1] = iconRegistry.registerIcon("CivCraft:swordHeadAluminium");
