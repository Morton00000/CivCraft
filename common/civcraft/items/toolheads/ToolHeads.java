...
public class ToolHeads {
	...
	public static final String[] axeHeadNames = { "Copper Axe Head", "Aluminium Axe Head", "Titanium Axe Head", "Depleted Uranium Axe Head", "Bronze Axe Head", "Steel Axe Head", "Carbide Axe Head", "Diamond Carbide Axe Head", "Iron Axe Head", "Gold Axe Head" };

	// Hoe Heads
	public static final Item hoeHead = new HeadsHoe(ItemIDs.HEAD_HOE);

	public static final String[] hoeHeadNames = { "Copper Hoe Head", "Aluminium Hoe Head", "Titanium Hoe Head", "Depleted Uranium Hoe Head", "Bronze Hoe Head", "Steel Hoe Head", "Carbide Hoe Head", "Diamond Carbide Hoe Head", "Iron Hoe Head", "Gold Hoe Head" };

	// Spade Head
	public static final Item spadeHead = new HeadsSpade(ItemIDs.HEAD_SPADE);

	public static final String[] spadeHeadNames = { "Copper Spade Head", "Aluminium Spade Head", "Titanium Spade Head", "Depleted Uranium Spade Head", "Bronze Spade Head", "Steel Spade Head", "Carbide Spade Head", "Diamond Carbide Spade Head", "Iron Spade Head", "Gold Spade Head" };

	// Pick Head
	public static final Item pickHead = new HeadsPick(ItemIDs.HEAD_PICK);

	public static final String[] pickHeadNames = { "Copper Pickaxe Head", "Aluminium Pickaxe Head", "Titanium Pickaxe Head", "Depleted Uranium Pickaxe Head", "Bronze Pickaxe Head", "Steel Pickaxe Head", "Carbide Pickaxe Head", "Diamond Carbide Pickaxe Head", "Iron Pickaxe Head", "Gold Pickaxe Head" };

	// Sword Head
	public static final Item swordHead = new HeadsSword(ItemIDs.HEAD_SWORD);

	public static final String[] swordHeadNames = { "Copper Sword Head", "Aluminium Sword Head", "Titanium Sword Head", "Depleted Uranium Sword Head", "Bronze Sword Head", "Steel Sword Head", "Carbide Sword Head", "Diamond Carbide Sword Head", "Iron Sword Head", "Gold Sword Head" };

	// Head Reference List
	// Axe
	public static ItemStack axeHeadCopper = new ItemStack(axeHead, 1, 0);
	public static ItemStack axeHeadAluminium = new ItemStack(axeHead, 1, 1);
	...
	public static ItemStack hoeHeadAluminium = new ItemStack(hoeHead, 1, 1);
	...
	public static ItemStack spadeHeadAluminium = new ItemStack(spadeHead, 1, 1);
	...
	public static ItemStack pickHeadAluminium = new ItemStack(pickHead, 1, 1);
	...
	public static ItemStack swordHeadAluminium = new ItemStack(swordHead, 1, 1);
