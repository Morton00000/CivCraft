...
public class ItemBucketPlastic extends Item {

	/** field for checking if the bucket has been filled. */
	private int isFull;

	public ItemBucketPlastic(int par1, int par2) {
		super(par1);
		isFull = par2;
	}
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if (var12 == null)
			...
			if (var12.typeOfHit == EnumMovingObjectType.TILE) {
				...
				if (isFull == 0) {
					...
					if (par2World.getBlockMaterial(var13, var14, var15) == Material.water && par2World.getBlockMetadata(var13, var14, var15) == 0) {
						...
						if (--par1ItemStack.stackSize <= 0)
							return new ItemStack(Items.bucketPlasticWater);

						if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Items.bucketPlasticWater))) {
							par3EntityPlayer.dropPlayerItem(new ItemStack(Items.bucketPlasticWater.itemID, 1, 0));
						}
					...
					if (isFull < 0)
						return new ItemStack(Items.bucketPlasticEmpty);
			...
			} else if (isFull == 0 && var12.entityHit instanceof EntityCow)
				return new ItemStack(Items.bucketPlasticMilk);
